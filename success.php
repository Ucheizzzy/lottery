        ...
        <div class="container d-flex justify-content-center align-items-center">
          <div class="row">
            <div class="col-12 mt-auto mb-5 text-center animate__animated animate__bounce">
              <small>Registeration Successful</small>

              <h1 class="text-white mb-5">Congratulations <?php if(isset($_REQUEST['msisdn'])) echo $_REQUEST['msisdn']; ?>. You Now Stand A Chance!</h1>
            </div>
